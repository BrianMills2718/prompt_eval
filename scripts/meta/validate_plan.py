...
REQUIRED_PLAN_SECTIONS = {
    "Gap": "Must describe what exists now and what we want (requirements).",
    "References Reviewed": "Must cite code/docs reviewed before planning (no guessing).",
    "Verification": "Must define how to verify the plan is complete (acceptance criteria).",
}
...
def validate_plan(plan_file: Path, plan_number: int | None, relationships: dict[str, Any]) -> ValidationResult:
    ...
    for section_name, reason in REQUIRED_PLAN_SECTIONS.items():
